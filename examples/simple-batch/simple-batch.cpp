...
int main(int argc, char **argv)
{
    ...
    // TODO: Something wrong with the last sequence here. Why does it not generate the right tokens? Outputs only 111...
    ...
    // TODO: This seems to only be an issue for the GPU build.
    ...
    // Print the tokens in the batch
    {
        ...
        for (const auto &tokens_list : batch_tokens)
        {
            fprintf(stderr, "\nBatch %d (len %d): ", batch_index++, (int)tokens_list.size());
